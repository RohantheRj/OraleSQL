...
insert into ssg values(sg1.currval,'ABC');
insert into m_2 values(sg1.currval,'UDAY');
...
insert into ssg1 values(1,'ABC');
insert into ssg1 values(2,'UDAY');
insert into ssg1 values(3,'UDAY1');
insert into ssg1 values(4,'UDAY2');
insert into ssg1 values(5,'UDAY3');
