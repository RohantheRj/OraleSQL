...
select round(months_between(sysdate,'15 Oct 1981')/12) as Age, 
round(months_between(sysdate,'10 July 2007')/12) as Experience from dual;

select ename, round(months_between(sysdate,hiredate)/12) as Experience from ee;
